...
import dem.core.commands.set_default_cmd as set_default_cmd
...
@patch("dem.core.commands.set_default_cmd.stdout.print")
...
@patch("dem.core.commands.set_default_cmd.stderr.print")
...
@patch("dem.core.commands.set_default_cmd.execute")
